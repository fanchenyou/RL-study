...
# code src https://github.com/ShangtongZhang/reinforcement-learning-an-introduction/blob/master/chapter05/blackjack.py
# tutorial https://github.com/applenob/rl_learn/blob/master/notes/intro_note_05.md
# Blackjack rules: search Internet
...
# Card number:
#   2-10:  same with card number
#   J,Q,K: 10
#   A:     1 if go burst else 11
# actions: hit or stand
# hit: deal you more cards
# stand: dont get any more cards
ACTION_HIT = 0
ACTION_STAND = 1  # "strike" in the book
ACTIONS = [ACTION_HIT, ACTION_STAND]

###############################################
# policy for player, the number is your sum
###############################################
POLICY_PLAYER = np.zeros(22, dtype=np.int)
for i in range(12, 20):
    POLICY_PLAYER[i] = ACTION_HIT  # can get any more cards without going bust (go over 21)
...
# otherwise (has equal to or more than 17), dealer *MUST* stop (STAND)
#####################################################################
...
def play(policy_player, initial_state=None, initial_action=None):
    ...
    if 1 == 1:
        if initial_state is None:
            ...
            # use specified initial state, one of the dealer card is visible
...
def monte_carlo_es(episodes):
    ...
    def behavior_policy(usable_ace, player_sum, dealer_card):
        ...
        # print(values_, [action_ for action_, value_ in enumerate(values_) if value_ == np.max(values_)])
...
def figure_5_1():
    ...
    plt.savefig('./img/figure_5_1.png')
    plt.close()
...
def figure_5_2():
    ...
    plt.savefig('./img/figure_5_2.png')
    plt.close()
...
def figure_5_3():
    ...
    plt.savefig('./img/figure_5_3.png')
    plt.close()
