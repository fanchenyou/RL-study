...
# code source https://github.com/ShangtongZhang/reinforcement-learning-an-introduction/blob/master/chapter02/ten_armed_testbed.py
# tutorial https://github.com/applenob/rl_learn/blob/master/notes/intro_note_02.md
...
class Bandit:
    ...
    def act(self):
        ...
        if self.gradient:
            ...
            # this bandit has K arms, each action goes to use one of the arms
            # each action prob is q_estimation
...
def figure_2_1():
    ...
    plt.savefig('./img/figure_2_1.png')
    plt.close()
...
def figure_2_2(runs=2000, time=1000):
    ...
    plt.savefig('./img/figure_2_2.png')
    plt.close()
...
def figure_2_3(runs=2000, time=1000):
    ...
    plt.savefig('./img/figure_2_3.png')
    plt.close()
...
def figure_2_4(runs=2000, time=1000):
    ...
    plt.savefig('./img/figure_2_4.png')
    plt.close()
...
def figure_2_5(runs=2000, time=1000):
    ...
    plt.savefig('./img/figure_2_5.png')
    plt.close()
...
def figure_2_6(runs=2000, time=1000):
    ...
    plt.savefig('./img/figure_2_6.png')
    plt.close()
