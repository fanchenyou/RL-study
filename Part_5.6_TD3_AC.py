...
code ref https://github.com/sfujim/TD3/blob/master/TD3.py
'''
...
def eval_policy(policy, env_name, seed, eval_episodes=10):
    ...
    print("---------------------------------------")
    print("Evaluation over {eval_episodes} episodes: {avg_reward:.3f}")
    print("---------------------------------------")
    return avg_reward


'''
python Part_5.5_DDPG_AC.py --policy "TD3" --env "Reacher-v"  --seed 123 --start_timesteps 1000
'''
if __name__ == "__main__":
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if (t + 1) % args.eval_freq == 0:
            ...
            np.save("./tmp/{file_name}", evaluations)
            if args.save_model: policy.save("./tmp/{file_name}")