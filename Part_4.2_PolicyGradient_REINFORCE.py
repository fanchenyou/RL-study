...
# http://incompleteideas.net/book/bookdraft2017nov5.pdf Section 13.3
...
def example_13_1():
    ...
    plt.savefig('./img/example_13_1.png')
    plt.close()
...
def figure_13_1():
    ...
    plt.savefig('./img/figure_13_1.png')
    plt.close()
...
def figure_13_2():
    ...
    plt.savefig('./img/figure_13_2.png')
    plt.close()
