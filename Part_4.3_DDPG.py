...
In short, DQN has to sample actions based on policy output (a probability distribution) with e-greedy
Instead, DDPG introduces noise and outputs the noisy action directly.
'''
...
def train(mu, mu_target, q, q_target, memory, q_optimizer, mu_optimizer):
    ...
    target = r + gamma * q_target(s_prime, mu_target(s_prime))  # action is directly taken from mu
